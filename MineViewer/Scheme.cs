    ...
    public class Scheme
    {
        ...
        static Scheme()
        {
            try
            {
                ...
                Names.Add("HugeRedMushroom", 100);
                Names.Add("IronBars", 101);
                Names.Add("GlassPane", 102);
                Names.Add("Melon", 103);
                Names.Add("PumpkinStem", 104);
                Names.Add("MelonStem", 105);
                Names.Add("Vines", 106);
                Names.Add("FenceGate", 107);
                Names.Add("BrickStairs", 108);
                Names.Add("StoneBrickStairs", 109);
                Names.Add("Mycelium", 110);
                Names.Add("LilyPad", 111);
                Names.Add("NetherBrick", 112);
                Names.Add("NetherBrickFence", 113);
                Names.Add("NetherBrickStairs", 114);
                Names.Add("NetherWart", 115);
                Names.Add("EnchantmentTable", 116);
                Names.Add("BrewingStand", 117);
                Names.Add("Cauldron", 118);
                Names.Add("EndPortal", 119);
                Names.Add("EndPortalFrame", 120);
                Names.Add("EndStone", 121);
                Names.Add("DragonEgg", 122);
                Names.Add("RedstoneLampOff", 123);
                Names.Add("RedstoneLampOn", 124);
                Names.Add("DoubleWoodenSlab", 125);
                Names.Add("WoodenSlab", 126);
                Names.Add("CocoaPod", 127);
                Names.Add("SandstoneStairs", 128);
                Names.Add("EmeraldOre", 129);
                Names.Add("EnderChest", 130);
                Names.Add("TripwireHook", 131);
                Names.Add("Tripwire", 132);
                Names.Add("EmeraldBlock", 133);
                Names.Add("SpruceWoodStairs", 134);
                Names.Add("BirchWoodStairs", 135);
                Names.Add("JungleWoodStairs", 136);
                Names.Add("CommandBlock", 137);
                Names.Add("Beacon", 138);
                Names.Add("CobblestoneWall", 139);
                Names.Add("FlowerPot", 140);
                Names.Add("Carrots", 141);
                Names.Add("Potatoes", 142);
                Names.Add("WoodenButton", 143);
                Names.Add("Head", 144);
                Names.Add("Anvil", 145);
                Names.Add("TrappedChest", 146);
                Names.Add("LightPressurePlate", 147);
                Names.Add("HeavyPressurePlate", 148);
                Names.Add("InactiveComparator", 149);
                Names.Add("ActiveComparator", 150);
                Names.Add("DaylightSensor", 151);
                Names.Add("BlockOfRedstone", 152);
                Names.Add("NetherQuartsOre", 153);
                Names.Add("Hopper", 154);
                Names.Add("QuartzBlock", 155);
                Names.Add("QuartsStairs", 156);
                Names.Add("ActivatorRail", 157);
                Names.Add("Dropper", 158);
                Names.Add("StainedClay", 159);
                Names.Add("StainedGlassPane", 160);
                Names.Add("NewLeaves", 161);
                Names.Add("NewLog", 162);
                Names.Add("AcaciaWoodStairs", 163);
                Names.Add("DarkOakStairs", 164);
                Names.Add("HayBale", 170);
                Names.Add("Carpet", 171);	
                Names.Add("HardenedClay", 172);
                Names.Add("BlockOfCoal", 173);
                Names.Add("PackedIce", 174);
                Names.Add("BigFlower", 175);
            }
            catch
            {
